...
public class Habitat {
    ...
    /**
     * Constructor de la clase Habitat que recibe todos los atributos necesarios
     * para inicializar un objeto Habitat.
     *
     ...
     * @param continentes lista de continentes que presentan este habitat
     */
    public Habitat(String nombre, String clima, String vegetacion, List<String> continentes) {
        this.nombre = nombre;
        this.clima = clima;
        this.vegetacion = vegetacion;
        this.continentes = continentes;
